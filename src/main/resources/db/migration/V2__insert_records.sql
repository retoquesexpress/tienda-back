...
(4, 'Gel', 'Construcción y diseño de uñas de gel de alta resistencia, proporcionando una estructura estética, equilibrada y natural que embellece la morfología de las manos.', 35, 'u3', 1),
(5, 'Añadir retirada', 'Procedimiento delicado de eliminación de producto anterior mediante técnicas no invasivas, seguido de una nueva aplicación de color para mantener la salud de la uña.', 6, 'u4', 1),
(6, 'Añadir dibujo', 'Transformación artística de la uña mediante diseños personalizados a mano alzada, adaptando patrones y tendencias exclusivas a tu estilo personal.', 6, 'u5', 1),
(7, 'Añadir joya', 'Exclusiva decoración mediante la aplicación de cristales, piedras semipreciosas y accesorios de lujo que aportan un relieve sofisticado y un brillo excepcional.', 1, 'u6', 1),
...
(14, 'Maquillaje + Skincare', 'Creación conceptual de vanguardia que utiliza el rostro como lienzo, combinando texturas, colores vibrantes y técnicas escénicas para resultados temáticos únicos.', 50, 'm3', 2),
(15, 'Maquillaje de Novia', 'Creación conceptual de vanguardia que utiliza el rostro como lienzo, combinando texturas, colores vibrantes y técnicas escénicas para resultados temáticos únicos.', 120, 'm3', 2),
(16, 'Descubre tu Colorimetría', 'Creación conceptual de vanguardia que utiliza el rostro como lienzo, combinando texturas, colores vibrantes y técnicas escénicas para resultados temáticos únicos.', 50, 'm3', 2),
...
(24, 'Despunte', 'Servicio de limpieza técnica de puntas diseñado para eliminar la porosidad y prevenir la rotura, manteniendo la vitalidad y el crecimiento óptimo de la fibra capilar.', 15, 'p1', 3),
(25, 'Corte + Secado', 'Experiencia de transformación completa que incluye un diagnóstico de visagismo, corte adaptado a tus rasgos y una sesión de secado profesional para un acabado perfecto.', 35, 'p2', 3),
(26, 'Tinte', 'Servicio de moldeado mediante técnicas de calor para aportar cuerpo, brillo y movimiento al cabello, adaptando el peinado a tus preferencias de volumen y forma.', 45, 'p4', 3);
